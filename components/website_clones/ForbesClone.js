                                    ...
                                    <div class="table" role="table" style="min-width: 0px;">
                                        ...
                                        <div class="table-body" role="rowgroup">
                                            <div class="table-row-group">
                                                <div class="left-rail">
                                                    <a class="left-rail-link"   rel="noopener noreferrer">
                                                        <div class="img-container"><img src="https://thumbor.forbes.com/thumbor/680x0/smart/filters:format(jpeg)/https%3A%2F%2Fimages.forbes.com%2FBillionaires2021-Sm-ThumbnailsForLander1%2FIconsOfExcellence-v1.png" alt="Icons Of Excellence"></div>
                                                    </a>
                                                    <div class="img-container"></div>
                                                    <a class="left-rail-link"   rel="noopener noreferrer">
                                                        <div class="sidebar-headline">
                                                            <h3>Icons Of Excellence</h3></div>
                                                    </a>
                                                    <div class="sidebar-description">BRANDVOICE | Under 30 Visionaries Creating New Paths To Sustainable Living</div>
                                                    <div class="read-more-link"><a   rel="noopener noreferrer">Read More <span><svg class="fs-icon fs-icon--chevron-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(134.999 10.1 12.701)" d="M5.4 11.5h9.5v2.4H5.4z"></path><path transform="rotate(-134.999 10.1 7.672)" d="M5.4 6.5h9.5v2.4H5.4z"></path></svg></span></a></div>
                                                </div>
                                                <div role="row" id="jeff-bezos" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">1.</div>
                                                    ...
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Technology <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="elon-musk" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">2.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Elon Musk </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Tesla, SpaceX<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Automotive <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="bernard-arnault" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">3.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Bernard Arnault &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$150 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">France</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>LVMH<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Fashion &amp; Retail <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="bill-gates" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">4.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Bill Gates </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Microsoft<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="mark-zuckerberg" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">5.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Facebook<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="warren-buffett" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">6.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Berkshire Hathaway<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Finance &amp; Investments <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="larry-ellison" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">7.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Larry Ellison </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$93 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>software<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="larry-page" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">8.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Larry Page </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Google<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="sergey-brin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">9.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Sergey Brin </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="mukesh-ambani" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">10.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Mukesh Ambani </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$84.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">India</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>diversified<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Diversified <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="amancio-ortega" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">11.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Amancio Ortega </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$77 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Spain</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Zara<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="francoise-bettencourt-meyers" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">12.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Francoise Bettencourt Meyers &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$73.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>L'Oréal<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="zhong-shanshan" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">13.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Zhong Shanshan </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$68.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">China</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>beverages, pharmaceuticals<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Food &amp; Beverage <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="steve-ballmer" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">14.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="ma-huateng" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">15.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Ma Huateng </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>internet media<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="carlos-slim-helu" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">16.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Carlos Slim Helu &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$62.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Mexico</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>telecom<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Telecom <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="alice-walton" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">17.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Alice Walton </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$61.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Walmart<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="jim-walton" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">18.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jim Walton </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="rob-walton" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">19.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Rob Walton </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="michael-bloomberg" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">20.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Michael Bloomberg </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$59 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Bloomberg LP<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Media &amp; Entertainment <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="colin-zheng-huang" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">21.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Colin Zheng Huang </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$55.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>e-commerce<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="mackenzie-scott" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">22.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>MacKenzie Scott </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$53 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="daniel-gilbert" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">23.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Daniel Gilbert </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$51.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Quicken Loans<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="gautam-adani-1" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">24.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Gautam Adani &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$50.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>infrastructure, commodities<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="phil-knight" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">25.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Phil Knight &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$49.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Nike<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="jack-ma" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">26.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jack Ma </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="charles-koch" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">27.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Koch Industries<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="julia-koch" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">27.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Julia Koch &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$46.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="masayoshi-son" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">29.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Masayoshi Son </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$45.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Japan</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>internet, telecom<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="michael-dell" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">30.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Dell computers<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="tadashi-yanai" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">31.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Tadashi Yanai &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$44.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>fashion retail<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="francois-pinault" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">32.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>François Pinault &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$42.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>luxury goods<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="david-thomson" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">33.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>David Thomson &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$41.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Canada</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>media<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="beate-heister-karl-albrecht-jr" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">34.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Beate Heister &amp; Karl Albrecht Jr. </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$39.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Germany</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>supermarkets<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="wang-wei" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">35.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Wang Wei </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>package delivery<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Service <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="miriam-adelson" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">36.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Miriam Adelson </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$38.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-NewToList1.svg" alt="new to list"></div>
                                                        </div>
                                                    </div>
                                                    <div class="age" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>75</div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>casinos<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Gambling &amp; Casinos <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="he-xiangjian" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">37.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>He Xiangjian </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$37.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>home appliances<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Manufacturing <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="dieter-schwarz" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">38.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Dieter Schwarz </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$36.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>retail<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="zhang-yiming" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">39.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Zhang Yiming </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$35.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>TikTok<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="giovanni-ferrero" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">40.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Giovanni Ferrero </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$35.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Italy</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Nutella, chocolates<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="alain-wertheimer" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">41.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Alain Wertheimer </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$34.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Chanel<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="gerard-wertheimer-1" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">41.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Gerard Wertheimer </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$34.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="li-ka-shing" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">43.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Li Ka-shing </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Hong Kong</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>diversified<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                ...
                                                <div role="row" id="qin-yinglin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">44.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Qin Yinglin &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$33.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>pig breeding<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="william-lei-ding" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">45.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>William Lei Ding </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$33 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>online games<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="len-blavatnik" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">46.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Len Blavatnik </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$32 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>music, chemicals<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="lee-shau-kee" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">47.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Lee Shau Kee </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$31.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>real estate<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Real Estate <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="jacqueline-mars" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">48.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jacqueline Mars </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$31.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>candy, pet food<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="john-mars" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">48.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>John Mars </div>
                                                    </div>
                                                ...
                                                <div role="row" id="yang-huiyan" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">50.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Yang Huiyan &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$29.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="alexey-mordashov-family" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">51.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Alexey Mordashov &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$29.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Russia</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>steel, investments<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Metals &amp; Mining <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="robin-zeng" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">52.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Robin Zeng </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>batteries<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="hui-ka-yan" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">53.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Hui Ka Yan </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="susanne-klatten" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">53.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Susanne Klatten </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$27.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>BMW, pharmaceuticals<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="vladimir-potanin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">55.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Vladimir Potanin </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$27 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>metals<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="dietrich-mateschitz" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">56.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Dietrich Mateschitz </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$26.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Austria</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Red Bull<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="pang-kang" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">57.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Pang Kang </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="klaus-michael-kuehne" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">58.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Klaus-Michael Kuehne </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$26.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>shipping<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Logistics <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="vladimir-lisin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">59.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Vladimir Lisin </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$26.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="wang-xing" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">60.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Wang Xing </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="german-larrea-mota-velasco" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">61.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>German Larrea Mota Velasco &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$25.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>mining<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="leonardo-del-vecchio" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">62.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Leonardo Del Vecchio &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$25.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>eyeglasses<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="takemitsu-takizaki" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">62.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Takemitsu Takizaki </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$25.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>sensors<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="leonard-lauder" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">64.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Leonard Lauder </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$25.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Estee Lauder<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="thomas-peterffy" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">65.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>discount brokerage<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="vagit-alekperov" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">66.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Vagit Alekperov </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$24.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>oil<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Energy <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="leonid-mikhelson" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">66.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Leonid Mikhelson </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$24.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>gas, chemicals<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="jim-simons" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">68.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jim Simons </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>hedge funds<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="jiang-rensheng" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">69.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jiang Rensheng &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$24.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>vaccines<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Healthcare <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="gina-rinehart" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">70.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Gina Rinehart </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$23.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Australia</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>mining<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                ...
                                                <div role="row" id="rupert-murdoch" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">71.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Rupert Murdoch &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$23.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>newspapers, TV network<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="shiv-nadar" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">71.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Shiv Nadar </div>
                                                    </div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>software services<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="zhang-zhidong" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">73.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Zhang Zhidong </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$23.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="iris-fontbona" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">74.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Iris Fontbona &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$23.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Chile</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>mining<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                ...
                                                <div role="row" id="lei-jun" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">75.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Lei Jun </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>smartphones<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="zhang-yong-1" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">75.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Zhang Yong </div>
                                                    </div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Singapore</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>restaurants<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="richard-qiangdong-liu" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">77.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Richard Qiangdong Liu </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$22.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="gennady-timchenko" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">78.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Gennady Timchenko </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$22 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="stephen-schwarzman" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">79.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Stephen Schwarzman </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$21.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>investments<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="goh-cheng-liang" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">80.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Goh Cheng Liang </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$21.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>paints<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="stefan-quandt" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">81.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Stefan Quandt </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$21.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>BMW<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="li-xiting" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">82.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Li Xiting </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>medical devices<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="pierre-omidyar" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">83.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Pierre Omidyar </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$21.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="stefan-persson" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">84.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Stefan Persson </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$21.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Sweden</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>H&amp;M<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="abigail-johnson" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">85.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Abigail Johnson </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$20.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>money management<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="r-budi-hartono" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">86.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>R. Budi Hartono </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$20.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Indonesia</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>banking, tobacco<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="andrew-forrest" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">87.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Andrew Forrest </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$20.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="ray-dalio" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">88.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Ray Dalio </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="michael-hartono" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">89.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Michael Hartono </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$19.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="li-shufu" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">89.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Li Shufu </div>
                                                    </div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>automobiles<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="zhong-huijuan" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">89.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Zhong Huijuan </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$19.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>pharmaceuticals<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="xu-hang" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">92.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Xu Hang </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="lui-che-woo" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">93.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Lui Che Woo </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="emmanuel-besnier" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">94.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Emmanuel Besnier </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$19.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>cheese<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="laurene-powell-jobs" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">95.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Laurene Powell Jobs &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$19 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Apple, Disney<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="eric-schmidt" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">96.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Eric Schmidt </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$18.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="sun-piaoyang" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">96.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Sun Piaoyang </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$18.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="theo-albrecht-jr" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">98.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Theo Albrecht, Jr. &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$18.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Aldi, Trader Joe's<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="alisher-usmanov" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">99.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Alisher Usmanov </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$18.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>steel, telecom, investments<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="robert-pera" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">100.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Robert Pera </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>wireless networking gear<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="wu-yajun" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">100.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Wu Yajun </div>
                                                    </div>
                                                ...
                                                <div role="row" id="fan-hongwei" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">102.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Fan Hongwei &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$18.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>petrochemicals<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="dhanin-chearavanont" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">103.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Dhanin Chearavanont </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$18.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Thailand</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>diversified<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                ...
                                                <div role="row" id="peter-woo" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">104.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Peter Woo </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="chen-bang" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">105.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Chen Bang </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>hospitals<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="andrey-melnichenko" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">105.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Andrey Melnichenko </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$17.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>coal, fertilizers<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="dustin-moskovitz" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">107.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Dustin Moskovitz </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$17.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="su-hua" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">107.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Su Hua </div>
                                                    </div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>video streaming<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="donald-newhouse" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">109.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Donald Newhouse </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$17.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="petr-kellner" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">110.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Petr Kellner </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$17.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Czechia</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>finance, telecommunications<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="lee-man-tat" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">111.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Lee Man Tat </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>food<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="pavel-durov" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">112.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Pavel Durov </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>messaging app<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="james-ratcliffe" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">113.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>James Ratcliffe </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$17 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">United Kingdom</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>chemicals<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="jorge-paulo-lemann" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">114.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jorge Paulo Lemann &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$16.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Brazil</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>beer<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="reinhold-wuerth" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">115.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Reinhold Wuerth &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$16.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>fasteners<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="charlene-de-carvalho-heineken" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">116.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Charlene de Carvalho-Heineken &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$16.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Netherlands</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Heineken<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="radhakishan-damani-1" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">117.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Radhakishan Damani </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$16.5 B
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>retail, investments<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="wang-chuanfu" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">118.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Wang Chuanfu </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$16.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="steve-cohen" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">119.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Steve Cohen </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="ken-griffin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">119.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Ken Griffin </div>
                                                    </div>
                                                ...
                                                <div role="row" id="chen-zhiping" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">121.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Chen Zhiping </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$15.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-NewToList1.svg" alt="new to list"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>e-cigarettes<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="ernest-garcia-ii" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">121.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Ernest Garcia, II. </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$15.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>used cars<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="uday-kotak" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">121.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Uday Kotak </div>
                                                    </div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>banking<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="carl-icahn" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">124.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Carl Icahn </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="suleiman-kerimov-family" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">124.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Suleiman Kerimov &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$15.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="thomas-frist-jr" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">126.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Thomas Frist, Jr. &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$15.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="lukas-walton" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">127.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Lukas Walton </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$15.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-DownArrow1.svg" alt="down arrow"></div>
                                                        </div>
                                                    </div>
                                                    <div class="age" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>34</div>
                                                ...
                                                <div role="row" id="mikhail-fridman" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">128.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Mikhail Fridman </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$15.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>oil, banking, telecom<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="wei-jianjun" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">128.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Wei Jianjun &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$15.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="zuo-hui" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">128.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Zuo Hui </div>
                                                    </div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>real estate services<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="zhou-qunfei" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">131.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Zhou Qunfei &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$15.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>smartphone screens<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="donald-bren" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">132.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Donald Bren </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="hinduja" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">133.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Hinduja brothers </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="lakshmi-mittal" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">133.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Lakshmi Mittal </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>steel<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="georg-schaeffler" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">133.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Georg Schaeffler </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="eric-yuan" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">133.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Eric Yuan &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>video conferencing<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="wang-jianlin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">137.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Wang Jianlin </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="kwong-siu-hing" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">138.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Kwong Siu-hing </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="robin-li" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">138.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Robin Li </div>
                                                    </div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>internet search<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="pallonji-mistry" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">140.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Pallonji Mistry </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Ireland</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>construction<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Construction &amp; Engineering <span class="expand-row__icon"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                    </div>
                                                </div>
                                                <div role="row" id="eduardo-saverin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">140.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Eduardo Saverin </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="roman-abramovich" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">142.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Roman Abramovich </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="david-tepper" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">142.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>David Tepper </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="gong-hongjia" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">144.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Gong Hongjia &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>video surveillance<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="mike-cannon-brookes" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">145.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Mike Cannon-Brookes </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="john-menard-jr" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">145.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>John Menard, Jr. </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>home improvement stores<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="seo-jung-jin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">145.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Seo Jung-jin </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">South Korea</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>biotech<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="cheng-yixiao" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">148.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Cheng Yixiao </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>video streaming app<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="liang-wengen" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">148.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Liang Wengen </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>construction equipment<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="scott-farquhar" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">150.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Scott Farquhar </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$14 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="finn-rausing" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">151.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Finn Rausing </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>packaging<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="jorn-rausing" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">151.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jorn Rausing </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="kirsten-rausing" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">151.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Kirsten Rausing </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="brian-chesky" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">154.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Brian Chesky </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Airbnb<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="joseph-lau" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">155.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Joseph Lau </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="david-duffield" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">156.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>business software<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="charoen-sirivadhanabhakdi" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">156.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Charoen Sirivadhanabhakdi </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>alcohol, real estate<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="kim-jung-ju" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">158.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Kim Jung-ju </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="robert-philip-ng" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">158.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Robert &amp; Philip Ng </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="zhang-bangxin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">158.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Zhang Bangxin </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>education<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="anders-holch-povlsen" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">161.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Anders Holch Povlsen </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Denmark</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>fashion retail<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                ...
                                                <div role="row" id="wang-wenyin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">161.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Wang Wenyin </div>
                                                    </div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>mining, copper products<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="wang-liping" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">163.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Wang Liping &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>hydraulic machinery<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="tatyana-bakalchuk" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">164.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Tatyana Bakalchuk </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>ecommerce<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="michael-platt" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">164.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Michael Platt </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$13 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="huang-shilin" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">166.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Huang Shilin </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$12.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="ricardo-salinas-pliego" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">166.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Ricardo Salinas Pliego &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$12.9 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>retail, media<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="kumar-birla" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">168.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Kumar Birla </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>commodities<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="dang-yanbao" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">169.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Dang Yanbao </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>coal<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="cyrus-poonawalla" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">169.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Cyrus Poonawalla </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$12.7 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="robert-kuok" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">171.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Robert Kuok </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Malaysia</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>palm oil, shipping, property<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="hank-doug-meijer" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">171.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Hank &amp; Doug Meijer </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$12.6 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="jack-dorsey" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">173.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jack Dorsey </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Twitter, Square<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="lu-zhongfang" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">173.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Lu Zhongfang </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$12.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="ma-jianrong" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">173.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Ma Jianrong &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$12.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="zhang-tao" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">173.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Zhang Tao </div>
                                                    </div>
                                                ...
                                                <div role="row" id="nathan-blecharczyk" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">177.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Nathan Blecharczyk </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$12.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="john-doerr" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">177.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>John Doerr </div>
                                                    </div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>venture capital<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="joe-gebbia" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">177.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Joe Gebbia </div>
                                                    </div>
                                                ...
                                                <div role="row" id="forrest-li" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">177.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Forrest Li </div>
                                                    </div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>gaming<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="yu-renrong" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">181.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Yu Renrong </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>semiconductors<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="liu-yonghao" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">182.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Liu Yonghao &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$12.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-DownArrow1.svg" alt="down arrow"></div>
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>agribusiness<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="gordon-moore" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">182.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="jeff-yass" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">184.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jeff Yass </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>trading, investments<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="bobby-murphy" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">185.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                    ...
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>Snapchat<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="patrick-drahi" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">186.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Patrick Drahi </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="jensen-huang-1" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">186.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="alexander-otto" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">186.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Alexander Otto </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.8 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="cen-junda" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">189.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Cen Junda </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="joseph-tsai" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">189.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Joseph Tsai </div>
                                                    </div>
                                                ...
                                                <div role="row" id="aliko-dangote" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">191.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Aliko Dangote </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Nigeria</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>cement, sugar<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                ...
                                                <div role="row" id="marcel-herrmann-telles" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">191.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Marcel Herrmann Telles </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.5 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="mikhail-prokhorov" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">193.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Mikhail Prokhorov </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.4 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="jorge-moll-filho" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">194.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Jorge Moll Filho &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.3 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="viktor-rashnikov" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">195.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Viktor Rashnikov </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="harry-triguboff" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">195.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Harry Triguboff </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.2 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="leonid-fedun-family" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">197.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Leonid Fedun &amp; family </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="eyal-ofer" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">197.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Eyal Ofer </div>
                                                    </div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Israel</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>real estate, shipping<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                        </div>
                                                    </div>
                                                    <div class="category" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                ...
                                                <div role="row" id="evan-spiegel" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">197.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Evan Spiegel </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11.1 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                ...
                                                <div role="row" id="luis-carlos-sarmiento" class="table-row " style="display: flex; flex: 1 0 auto; min-width: 0px;">
                                                    <div class="rank" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">200.</div>
                                                    <div class="personName" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>Luis Carlos Sarmiento </div>
                                                    </div>
                                                    <div class="netWorth" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div>$11 B
                                                            <div class="status"><img src="https://images.forbes.com/assets/list-landers/forbes-400-2020/Forbes400-UpArrow1.svg" alt="up arrow"></div>
                                                    ...
                                                    <div class="countryOfCitizenship" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">Colombia</div>
                                                    <div class="source" role="cell" style="box-sizing: border-box; flex: 150 0 auto; min-width: 0px; width: 150px;">
                                                        <div class="source-column">
                                                            <div>banking<span class="expand-row__icon expand-row__icon--mobile"><svg class="fs-icon fs-icon--chevron-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.8 19.8"><path transform="rotate(45.001 12.615 10.187)" d="M7.9 9h9.5v2.4H7.9z"></path><path transform="rotate(134.999 7.586 10.187)" d="M2.8 9h9.5v2.4H2.8z"></path></svg></span></div>
                                                            <div class="spac-star"></div>
                                                ...
                                                <div class="below-row-content">
                                                    <div class="reprints"><a >Spreadsheet</a><a   rel="noopener noreferrer">Reprints</a></div>
                                                    <div class="pagination">
                                                        <button class="pagination-btn pagination-btn--prev pagination-btn--disabled">
                                                            <div class="previous-page"><i class="bubble-arrow"><svg class="fs-icon fs-icon--arrow-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2.5 10h16v2h-16z"></path><path transform="rotate(-45.001 4.5 8.877)" d="M.5 7.9h8v2h-8z"></path><path transform="rotate(45.001 4.5 13.124)" d="M.5 12.1h8v2h-8z"></path></svg></i><span class="bubble-arrow__label">Previous 200</span></div>
                                                        </button>
                                                        <div class="goto-page">
                                                            <button class="goto-page__btn" aria-label="go to page 0" disabled=""></button>
                                                            <button class="goto-page__btn" aria-label="go to page 1"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 2"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 3"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 4"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 5"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 6"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 7"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 8"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 9"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 10"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 11"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 12"></button>
                                                            <button class="goto-page__btn" aria-label="go to page 13"></button>
                                                        </div>
                                                        <button class="pagination-btn pagination-btn--next ">
                                                            <div class="next-page"><span class="bubble-arrow__label">Next 200</span><i class="bubble-arrow"><svg class="fs-icon fs-icon--arrow-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path transform="rotate(-180 8.964 11)" d="M1 10h16v2H1z"></path><path transform="rotate(134.999 14.965 13.124)" d="M11 12.1h8v2h-8z"></path><path transform="rotate(-134.999 14.965 8.877)" d="M11 7.9h8v2h-8z"></path></svg></i></div>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
